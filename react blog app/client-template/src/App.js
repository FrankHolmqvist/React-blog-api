...
function App() {
    return ( <div className="App"> { /* Router enables component to use the routing capabilities  */ } <Router>
        <Nav/>

        { /* Switch ensures that only 1 component renders. Stop rendering other components as soon as it gets a match */ } <Switch> { /* Route associates a path with a specific component */ } <
        Route path = "/items"
        component = { ShowList }
        /> <
        Route path = "/item/:id"
